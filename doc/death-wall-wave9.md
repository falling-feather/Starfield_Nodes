...
> 输入：[doc/bench-report-long.md](./bench-report-long.md)（5 pool × 5 seed × 5 level × waves=20，125 runs）  
...
- 在改动前先把当前 baseline 数据归档为 `doc/bench-report-long-pre-balance.md` 作为 A/B 基线。
